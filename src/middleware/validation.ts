...
//     body("restaurantName").isString().notEmpty().withMessage("Restaurant name is requierd"),
//     body("city").isString().notEmpty().withMessage("City name is requierd"),
//     body("country").isString().notEmpty().withMessage("Country is requierd"),
...
//     body("menuItems.*.price").isFloat({min: 0}).withMessage("Menu item price must be a postive number"),
//     handleValidationErrors,
// ]
